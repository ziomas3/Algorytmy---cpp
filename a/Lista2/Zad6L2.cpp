...
lnode* merge (lnode *L1, lnode *L2) //jeśli funkcja ma zwrócić wskaźnik to musi być * przy nazwie - wskaźnik L1 nołdowy
{
    if (!L1)
    {
        licznik++;
    ...
    if (L1->x < L2->x) //składowa o nazwie x obiektu wskazywanego przez wskaźnik o nazwie L1/L2
    {
        licznik++;
